    ...
    <div className="enrollment">
      ...
      <div className="program">
        <div className="card">
          ...
          <p className="ps-3">
            lorem paratage experince work the server the unverisity graduation
            of the year
          </p>
        </div>
      </div>
      ...
      <h6 className="mt-3" style={{ color: "#087FFF" }}>
        Consult Real Experts for free!
      </h6>
      <div className="contact mt-3">
        <button style={{ background: "green", color: "white" }}>
          <FaWhatsapp /> Whatsapp{" "}
        </button>
        <button style={{ background: "darkblue", color: "white" }}>
          <IoCall /> Call Now{" "}
        </button>
      </div>
    </div>
