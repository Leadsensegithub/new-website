    ...
    <div className="row">
      ...
      <ul className="ugsidebarList">
        ...
        <li className={active === "/PGCourses/MCOM" ? "sidebarItem active" : "sidebarItem"}
                    ...
                    onClick={() => UGpage("/PGCourses/MSC")}><FaGraduationCap style={{marginRight:"5px" ,color:"white",backgroundColor:"#1868ae"}}/>MSC</li>
      </ul>
      </div>
      </div>
    ...
    <div className="col-lg-9">
        ...
        {msc?.map((data,index)=>(
                ...
                <div className='card mt-5' key={index}>
                    ...
                    <h6 className='text-center mt-3'>MSC ({data.degreename})</h6>
